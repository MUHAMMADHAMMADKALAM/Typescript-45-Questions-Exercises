...
console.log("Tests for inequality with strings: ",("Motorcycle" as string)!="cycle");
...
console.log("Tests for inequality with numbers: ", (21 as number) != 31 );
...
//Test whether an item is in a array
  const Fruites :string[] =['Mango','Staubry','Apple'];
console.log('Test "Mango" in a array: ' ,Fruites.includes("Staubry"));

// Test whether an item is not in a array
console.log('Test "Banana" is not in a array: ' , !Fruites.includes("Banana"));
